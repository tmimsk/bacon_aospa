...
#if defined (CONFIG_VENDOR_EDIT) || defined (CONFIG_OPPO_MSM_14021)
static bool bq27541_authenticate(struct i2c_client *client)
{
	return true;
}
...
#else //defined (CONFIG_VENDOR_EDIT) || defined (CONFIG_OPPO_MSM_14021)
...
#endif //defined (CONFIG_VENDOR_EDIT) || defined (CONFIG_OPPO_MSM_14021)
#endif //CONFIG_VENDOR_EDIT
